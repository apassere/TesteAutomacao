...
public class RealizarCompra {
	...
	sCelular, sNomeEndereco, sEmail,sDiaNasc,sMesNasc, sAnoNasc, primeiraExecucao, resultadoEsperado;
	...
	// Métodos para Leitura de Massa de Teste
		...
		public static Collection<String[]> LerArquivo() throws IOException{
			return lerCSV("C:\\Iterasys\\FTS117\\massa\\massaDB.csv");
		}
	...
	public static void AntesDaClasse() {
		nomePasta = "C:\\Iterasys\\FTS117\\evidencias" +
